...
Criar e alterar arquivos sempre no workspace ou repositorio ativo do usuario. Nunca criar projetos, testes, dependencias, documentacao ou arquivos de automacao dentro da pasta global da skill, como `~/.agents/skills/playwright-mcp-e2e-automation`, salvo se o usuario pedir explicitamente para editar a propria skill.
